...
<%@ page import="java.util.*, java.sql.*, java.util.Random" %>
	...
	<% if(session.getAttribute("roleName") != null) { %>
		<% if(request.getParameter("totalOrder") != null && !request.getParameter("totalOrder").equals("")) {
			try {
				if(Integer.parseInt(request.getParameter("totalOrder")) <= 0 ) {
					...
					String GET_RANDOM_5_PRODUCTS = "SELECT \"ProductID\", \"Price\" FROM products OFFSET floor(random()* (select count(*) from products)) LIMIT 5";
		...
		<table cellspacing="5">
			<tr>
				...
				<form method="GET" action="../../../../Downloads/buyOrders.jsp" id="buyOrders">
